...
def goal_response() -> str:
    ...
    return (
        ...
        f"Najbliższy cel wdrożeniowy po {RECIPE_TEST_FOLLOWUP_VERSION}: jeszcze lepsze proactive recipe follow-ups, approval/start iPhone Shortcuts service, potem prywatny iMessage/Messages bridge."
    )
